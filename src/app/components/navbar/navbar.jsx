...
            if (
                isActive &&
                !e.target.closest(`.${styles.menuDrawer}`) &&
                !e.target.closest(`.${styles.Bars}`)
            ) {
                setIsActive(false);
            }
        };
...
                <li><Link href={'/'} onClick={handleLinkClick}>Todos</Link></li>
                <li><Link href={'#Brincos'} onClick={handleLinkClick}>Brincos</Link></li>
                <li><Link href={'#Piranhas'} onClick={handleLinkClick}>Piranhas</Link></li>
                <li><Link href={'#Maquiagens'} onClick={handleLinkClick}>Maquiagem</Link></li>
                <li><Link href={'#Pulseiras'} onClick={handleLinkClick}>Pulseiras</Link></li>
                <li><Link href={'#Aneis'} onClick={handleLinkClick}>Anéis</Link></li>
                <li><Link href={'#Fones'} onClick={handleLinkClick}>Fones</Link></li>
                <li><Link href={'#Capas'} onClick={handleLinkClick}>Capinhas de Celular</Link></li>
            </ul>
        </nav>
    );
}
